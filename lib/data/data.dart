...
const categories = [
  Category(
    ...
    imagePath: 'assets/category_images/c1.png',
  ),
  Category(
    imagePath: 'assets/category_images/c2.png',
    id: 'c2',
    title: 'Fantasy',
    color: Color(0xFF9575CD),
  ),
  Category(
    imagePath: 'assets/category_images/c3.png',
    id: 'c3',
    title: 'Adventure',
    color: Color(0xFF4DB6AC),
  ),
  Category(
    imagePath: 'assets/category_images/c4.png',
    id: 'c4',
    title: 'Animal Stories',
    color: Color(0xFFF06292),
  ),
  Category(
    imagePath: 'assets/category_images/c5.png',
    id: 'c5',
    title: 'Folktales',
    color: Color(0xFFFFA726),
  ),
  Category(
    imagePath: 'assets/category_images/c6.png',
    id: 'c6',
    title: 'Science Fiction',
    color: Color(0xFF64B5F6),
  ),
  Category(
    imagePath: 'assets/category_images/c7.png',
    id: 'c7',
    title: 'Mystery',
  ...
  Category(
    id: 'c8',
    imagePath: 'assets/category_images/c8.png',
    title: 'Humor',
    color: Color(0xFF81C784),
  ),
  Category(
    id: 'c9',
    imagePath: 'assets/category_images/c9.png',
    title: 'Friendship',
    color: Color(0xFFFFD700),
  ),
  Category(
    id: 'c10',
    imagePath: 'assets/category_images/c10.png',
    title: 'Historical Fiction',
    color: Color(0xFF8D6E63),
  ),
  Category(
    id: 'c11',
    imagePath: 'assets/category_images/c11.png',
    title: 'Picture Books',
    color: Color(0xFFFFC107),
  ),
  Category(
    imagePath: 'assets/category_images/c12.png',
    id: 'c12',
    title: 'Educational',
  ...
  Category(
    id: 'c13',
    imagePath: 'assets/category_images/c13.png',
...
//     imageUrl:
//         'https://res.cloudinary.com/dgvv3j3st/image/upload/v1692499599/kids_stories_app/Zara%20and%20the%20Enchanted%20Forest/rayqzeycbujunoqchea6.png',
//     categories: ['c2', 'c9'],
//     // 'Fantasy', 'Friendship'
//     complexity: Complexity.simple,
//     duration: 24,
